...
resource "oci_cloud_guard_target" "test_target" {
    #Required
    compartment_id = var.compartment_Non_Security_Zone_ocid
     display_name = var.Cloud_Guard_target1_display_name
    target_resource_id = var.compartment_Non_Security_Zone_ocid
...
resource "oci_cloud_guard_target" "test_target2" {
    #Required
    compartment_id = var.compartment_Security_Zone_ocid
   display_name = var.Cloud_Guard_target2_display_name

target_resource_id = var.compartment_Security_Zone_ocid
   target_resource_type = var.target_target_resource_type
description   = var.target_description
  state         = var.target_state

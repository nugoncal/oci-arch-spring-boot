...
variable "region" {}
variable "compartment_Non_Security_Zone_ocid" {}
variable "compartment_Security_Zone_ocid" {}
...
variable "Cloud_Guard_target1_display_name" {
  default = "Non_Security_Zone_Compartment"
}

variable "Cloud_Guard_target2_display_name" {
  default = "Security_Zone_Compartment"
}
